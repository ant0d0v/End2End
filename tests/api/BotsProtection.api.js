...
test.describe.configure({ mode: "default" }); 
  ...
  test("Brazilian Bots and Error 429 Page /shopping search @api", async ({
    ...
    // Action
    const response = await botsProtection.makeSearchRequestAndGetResponseForShopping(
  ...
  test("Check Queries Rate Limit for Regular Bot /image search @api", async ({
    ...
    // Action
    const response =
      await botsProtection.makeSearchRequestAndGetResponseForImage(
  ...
  test("Check Queries Rate Limit for Regular Bot /video search @api", async ({
    ...
    // Action
    const response =
      await botsProtection.makeSearchRequestAndGetResponseForVideo(
  ...
  test("Check Queries Rate Limit for Regular Bot /music search @api", async ({
    ...
    // Action
    const response =
      await botsProtection.makeSearchRequestAndGetResponseForMusic(
