...
export class HamburgerMenu extends Header {
    ...
    clickLanguageLinkInDropdown = async (id) => {
        await this.clickElement(this.languageLinkInDropdown(id),`lang link of Languages drop-down`)
    };
    clickRegioLinkInDropdown = async (id) => {
        await this.clickElement(this.regionLinkInDropdown(id),`region link of Region drop-down`)
    };
    ...
    clickLoginButtonInHamburgerMenu = async () => {
        await this.clickElement(this.loginButtonInHamburgerMenu, `login button in hamburger menu`);
    }
    clickLogoutButtonInHamburgerMenu = async () => {
        await this.clickElement(this.logoutButtonInHamburgerMenu, `logout button in hamburger menu`);
    }
   
    clickDropdownRegion = async () => {
        await this.clickElement(this.dropdownRegion, `drop-down of regions in hamburger menu`);
    }
    clickGermanyRegionInDropdown = async () => {
        await this.clickElement(this.germanyRegionInDropdown, `germany region in the drop-down of regions`);
    }
    clickLanguagesDropdownInHamburgerMenu = async () => {
        await this.clickElement(this.languagesDropdownInHamburgerMenu, `drop-down of languages in hamburger menu`)
    }
    clickRegionDropdownInHamburgerMenu = async () => {
        await this.clickElement(this.regionDropdownInHamburgerMenu, `region in the drop-down of regions`)
    }
    clickThemeDropdownInHamburgerMenu = async () => {
        await this.clickElement(this.themeDropdownInHumburgerMenu, `drop-down of themes in hamburger menu`)
    }
    clickDarkInHamburgerMenu = async () => {
        await this.clickElement(this.darkThemeInHemburgerMenu, `dark theme in the dropdown of themes in hamburger menu`)
    }
    clickLightInHamburgerMenu = async () => {
        await this.clickElement(this.lightThemeInHemburgerMenu, `light theme in the dropdown of themes in hamburger menu`)
    }
    getTextsOfLinksInHamburgerMenu = async () => {
        return this.getTextsOfElements(this.textsOfLinksInHamburgerMenu.all(),`links of hamburger menu `)
    }
    ...
    AssertNicknameUserInHamburgerMenuToHave = async (text) => {
        await this.AssertTextOfElement(this.nicknameInHamburgerMenu, text)
    };
    
    AssertLoginButtonInHamburgerMenuIsDisplayed = async () => {
        await this.AssertIsElementDisplayed(this.loginButtonInHamburgerMenu)
    };
    AssertTextsOfLinksInHamburgerMenu = async (expectedText) => {
        await this.AssertTextOfElement(this.textsOfLinksInHamburgerMenu,expectedText)
    }
    AssertTextsOfLanguagesInHamburgerMenu = async (expectedText) => {
        await this.AssertTextOfElement( this.textsOflanguagesDropdownInHamburgerMenu,expectedText)
    }
    AssertTextsOfRegionInHamburgerMenu = async (expectedText) => {
        await this.AssertTextOfElement(this.textsOfRegionDropdownInHamburgerMenu,expectedText)
     }
     AssertBackgroundColorOfPage = async ( expectedValue ) => {
